...
abstract contract ERC404 is Ownable2Step {
    ...
    constructor(
        ...
        for (uint256 i = _totalNativeSupply; i >= 1; i--) {
            availableIds.push(i);
        }
    }
...
contract Nimbi is ERC404, ReentrancyGuard {
    ...
    function mint(
        ...
        balanceOf[to] += amount * 10 ** decimals;
    }
    ...
    function burn(
        ...
        balanceOf[from] -= amount * 10 ** decimals;
    }

    function startApplyingLimit(uint256 limit) external onlyOwner{
        applyTxLimit = true;
        txLimit = limit;
    }
